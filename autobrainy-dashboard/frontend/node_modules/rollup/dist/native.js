...
// Prefer WASM build when available to avoid loading native .node binaries
let _wasm;
try {
	_wasm = require('@rollup/wasm-node');
} catch (e) {
	_wasm = null;
}
if (_wasm) {
	module.exports.parse = _wasm.parse;
	module.exports.parseAsync = _wasm.parseAsync;
	module.exports.xxhashBase64Url = _wasm.xxhashBase64Url;
	module.exports.xxhashBase36 = _wasm.xxhashBase36;
	module.exports.xxhashBase16 = _wasm.xxhashBase16;
	return;
}
